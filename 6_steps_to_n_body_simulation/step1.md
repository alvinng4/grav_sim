...
## Full script
The full script is available at `12_steps_to_n_body_simulation/python/step1.py`,
or https://github.com/alvinng4/grav_sim/blob/main/12_steps_to_n_body_simulation/python/step1.py

??? note "Code (Click to expand)"
    ```python linenums="1"
    --8<-- "12_steps_to_n_body_simulation/python/step1.py"
    ```